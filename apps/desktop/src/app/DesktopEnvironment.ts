...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "t3kanban-dev" : "t3kanban";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.t3tools.t3kanban.dev" : "com.t3tools.t3kanban",
    ),
    linuxDesktopEntryName: isDevelopment ? "t3kanban-dev.desktop" : "t3kanban.desktop",
    linuxWmClass: isDevelopment ? "t3kanban-dev" : "t3kanban",
