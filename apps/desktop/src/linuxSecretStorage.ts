...
function getGnomeKeyringRemediationMessage(): string {
  return "T3 Kanban could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart T3 Kanban.";
}

function getKWalletRemediationMessage(): string {
  return "T3 Kanban could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart T3 Kanban.";
}
